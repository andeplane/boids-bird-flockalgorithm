...
public:
    ...
    float separationDistance = 0.01;
    float cohesionDistance = 0.2;
    float alignmentDistance = 0.1;
    float mouseDistance = 0.3;
    float obstacleDistance = 0.2;
    float obstacleForceMagnitude = 0.5;
    float mouseForceMagnitude = 0.5;
    float separationForceMagnitude = 0.05;
    float cohesionForceMagnitude = 0.2;
    float alignmentForceMagnitude = 0.5;
